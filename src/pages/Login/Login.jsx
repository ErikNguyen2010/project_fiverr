          ...
          <div className="site-card-border-less-wrapper">
              ...
              <h1 className='login__header mb-2'>Sign In to Fiverr</h1>
                  ...
                  >
                      ...
                      >
                      <Input id='email' onChange={handleChange} prefix={<UserOutlined className="site-form-item-icon" />} placeholder="Email" />
                      </Form.Item>
                      <Form.Item
                      name="password"
                      rules={[
                      ...
                      <div className='text-center'>
                          ...
                          <NavLink  className='login__register' to="/register">Register now!</NavLink>
                      </div>
                      </Form.Item>
                  </Form>
              </Card>
