 ...
 function UserInfo(props) {
  ...
  return (
    <div style={{padding: "50px"}} id="infoAdmin">
      <h1 style={{fontSize: "30px", color:"black", fontWeight: "bold"}} className="text-center mb-5">{userLogin.role}: {userLogin.name}</h1>
      <div>
        <NavLink to={`/admin/user/edituser/${userLogin._id}`} className="button-update-info btn__login btn btn-success">Edit Người Dùng</NavLink>
        </div>
