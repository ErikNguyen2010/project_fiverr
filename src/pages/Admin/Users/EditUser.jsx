        ...
        <h1 className='text-center mb-5' style={{fontSize: "30px", fontWeight:"bold", color:"black"}}>Edit Người Dùng</h1>
             <Form
                ...
                <Form.Item label="Email">
                    <Input disabled onChange={formik.handleChange} name='email' value={formik.values.email} placeholder='Email' />
                </Form.Item>
                <Form.Item label="Mật Khẩu">
                    <Input.Password onChange={formik.handleChange} name='password' value={formik.values.password} placeholder='Mật khẩu' />
                </Form.Item>
             
                <Form.Item label="Họ Tên">
                    <Input onChange={formik.handleChange} name='name' value={formik.values.name} placeholder='Họ tên' />
                </Form.Item>

                <Form.Item label="Số Điện Thoại">
                    <Input onChange={formik.handleChange} name='phone' value={formik.values.phone} placeholder='Số điện thoại' />
                </Form.Item>
