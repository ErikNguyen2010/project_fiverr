  ...
  return (
    <section className='edituser'>
        <h1 className='text-center mb-5' style={{fontSize: "30px", fontWeight:"bold", color:"black"}}>Edit Công Việc</h1>
             <Form
                ...
                <Form.Item label="Price">
                    <InputNumber  value={formik.values.price} name='price' onChange={(value) =>{
                      formik.setFieldValue("price",value)
                    }} min={0} max={100000}/>{" "}
                </Form.Item>
                <Form.Item label="Rating">
                      <InputNumber value={formik.values.rating} name='rating' onChange={(value) =>{
                  ...
                  <Form.Item label="ProServices" valuePropName="checked">
                    <Switch checked={formik.values.proServices} name="proServices" onChange={handleChangeSwitch("proServices")}  />
                </Form.Item>

                <Form.Item label="Local Sellers" valuePropName="checked">
                    <Switch checked={formik.values.localSellers} name="localSellers" onChange={handleChangeSwitch("localSellers")}  />
                </Form.Item>

                <Form.Item label="Online Sellers" valuePropName="checked">
                    <Switch checked={formik.values.onlineSellers} name="onlineSellers" onChange={handleChangeSwitch("onlineSellers")}  />
                </Form.Item>

                <Form.Item label="Delivery Time" valuePropName="checked">
                    <Switch checked={formik.values.deliveryTime} name="deliveryTime" onChange={handleChangeSwitch("deliveryTime")}  />
                </Form.Item>
        ...
        >
          ...
          /> */}
          <Input name="image" value={formik.values.image} onChange={formik.handleChange} placeholder="Enter link image"/> <br />
          <div
            style={{
              width: "300px",
              height: "200px",
